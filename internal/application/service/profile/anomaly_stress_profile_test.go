...
func (mrs *MockRequestService) Get(req *entity.Request) entity.Response {
	testMu.Lock()
	mrs.getCount++
	testMu.Unlock()
...
func (mrs *MockRequestService) Post(req *entity.Request) entity.Response {
	testMu.Lock()
	mrs.postCount++
	testMu.Unlock()
...
func (mrs *MockRequestService) PostForm(req *entity.Request) entity.Response {
	testMu.Lock()
	mrs.postFormCount++
	testMu.Unlock()
